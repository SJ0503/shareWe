...
<%
	...
	<div class="container-fluid page-header py-5">
		<h1 class="text-center text-white display-6">기업 회원 승인</h1>
		<ol class="breadcrumb justify-content-center mb-0">
			<li class="breadcrumb-item active text-white">corporate
				membership approval</li>
		</ol>
	</div>
						...
						<c:forEach items="${adApprove}" var="a" >
							<tr>
								...
								<td><button type="button"
										onclick="location.href='approveComplete?email=${a.email}'">승인</button></td>
