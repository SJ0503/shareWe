...
<body>
	...
	<c:choose>
		<c:when test="${joinMember.type == 2 || joinMember.type == 3}">
			<div class="container-fluid page-header py-5"
				...
				<h4 class="text-center text-white display-7"
					style="align-content: middle">회원가입을 축하합니다.</h4>
				<br>
				<h5 class="text-center text-white display-7">가입된 이메일은
					${joinMember.email}입니다.</h5>
			</div>
		</c:when>
		...
		<c:otherwise>
			<div class="container-fluid page-header py-5"
				...
				<ol class="breadcrumb justify-content-center mb-0">
					<li class="breadcrumb-item active text-white">Waiting for
						approval</li>
				</ol>
				<br>
				<h4 class="text-center text-white display-7"
					style="align-content: middle">승인대기 중인 이메일은
					${joinMember.email}입니다.</h4>
				<br>
					...
					<div class="col-md-12 col-lg-6 col-xl-7" align="center">
						<div class="actions vertical">
							...
							<button type="button" onclick="location.href='goLogin'"
								class="btn border-secondary py-3 px-4 text-uppercase w-50 text-primary"
								style="width: 200px !important; display: inline-block !important;">로그인</button>
							</a>
						</div>
					</div>
				</div>
