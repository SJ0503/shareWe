         ...
         <form action="gBoardUpdate" method="post"
            ...
            <div class="row g-5 justify-content-center" id="loginDiv">
					...
					<div class="col-md-12 col-lg-6 col-xl-7" align="left">
						...
						<input type="hidden" value="${loginMember.nick }" name="g_writer">
                     ...
                     <div class="contents" style="width: 220px; height: 225px;">
                        <div class="upload-box" style="margin-right: 30px !important;">
                           ...
                           <label class="file-label" for="chooseFile1"
                              ...
                              class="file" id="chooseFile1" type="file" name="g_img1" value="${g_board.g_img1}"
                     ...
                     <div class="contents" style="width: 220px; height: 225px;">
                        <div class="upload-box" style="margin-right: 30px !important;">
                           ...
                           <label class="file-label" for="chooseFile2"
                              ...
                              class="file" id="chooseFile2" type="file" name="g_img2" value="${g_board.g_img2}"
                     ...
                     <div class="contents" style="width: 220px; height: 225px;">
                        <div class="upload-box" style="margin-right: 30px !important;">
                           <div id="drop-file3" class="drag-file">
                              <img
                                 src="resources/g_Image/${g_board.g_img3}"
                                 style="height: 150px; width: 189px;">
                              <p class="message">Drag files to upload</p>
                              <img src="" alt="미리보기 이미지" class="preview">
                           </div>
                           <label class="file-label" for="chooseFile3"
                              ...
                              class="file" id="chooseFile3" type="file" name="g_img3" value="${g_board.g_img3}"
    ...
    function handleFiles(files, dropAreaId) {
        ...
        if (fileList) {
			 ...
			 <div class="col-md-12 col-lg-6 col-xl-7" align="left">
               ...
               <div class="form-item">
                  <textarea name="g_content" rows="6" cols="80"
                     style="border-radius: 5px">${g_board.g_content}</textarea>
               </div>
               <hr>
             </div>
            ...
            <div class="col-md-12 col-lg-6 col-xl-7" align="left">
               ...
               <div class="form-item">
                  <div class="col-sm-8">
                     <select name="category" id="a4" class="form-control" value="${g_board.category}">
